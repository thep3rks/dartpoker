...
["actors", "model/actors.dart", , {
Dealer: {"": "Object;deck,players,_onDealCompleteEvent",
  dealToAllPlayers$1: function(cardCount) {
    var i, t1, p, t2;
    for (i = 0; i < cardCount; ++i)
      for (t1 = this.players, t1.get$iterator, t1 = new $.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
        p = t1._liblib$_current;
        t2 = this.deck;
        t2.deal$0;
        p.addCard$1(t2.draw$1(0));
      }
    this._onDealCompleteEvent.signal$0();
  }
},
...
Player: {"": "Object;hand",
  ...
  printHand$0: function() {
    var i, t1;
    $.Primitives_printString("*********HAND Length " + this.hand.cards.length + "*********");
    for (i = 0; t1 = this.hand.cards, i < t1.length; ++i)
      $.Primitives_printString($.toString$0($.toString$0(t1[i])));
  }
}}],
["cardViews", "view/cardViewItem.dart", , {
CardViewItem: {"": "Object;cardElement",
  CardViewItem$1: function(c) {
    var de, divClass, t1, t2, s1, s2, t3;
    this.cardElement = document.createElement("li");
    de = document.createElement("div");
    divClass = "card rank-" + $.S(c.get$rank()) + " " + $.S(c.get$suit());
    t1 = $.getInterceptor$x(de);
    t2 = t1.get$classes(de);
    t2.add$1(t2, divClass);
    s1 = document.createElement("span");
    t2 = $.get$classes$x(s1);
    t2.add$1(t2, "rank");
    s1.textContent = $.toUpperCase$0$s(c.get$rank());
    s2 = document.createElement("span");
    t2 = $.getInterceptor$x(s2);
    t3 = t2.get$classes(s2);
    t3.add$1(t3, "suit");
    t2.set$innerHtml(s2, "&" + $.S(c.get$suit()) + ";");
    t2 = t1.get$children(de);
    t2.add$1(t2, s1);
    t1 = t1.get$children(de);
    t1.add$1(t1, s2);
    t1 = $.get$children$x(this.cardElement);
    t1.add$1(t1, de);
  }
},

CardViewItem$: function(c) {
  var t1 = new $.CardViewItem(null);
  t1.CardViewItem$1(c);
  return t1;
}}],
...
_ControllerStream: {"": "_StreamImpl;_liblib2$_controller,_hasListener",
  ...
  _onListen$1: function(subscription) {
    this._liblib2$_controller._recordListen$1(subscription);
  },
...
_ControllerSubscription: {"": "_BufferingStreamSubscription;_liblib2$_controller<,_onData,_onError,_onDone,_state,_pending",
  _onCancel$0: function() {
    this.get$_liblib2$_controller()._recordCancel$1(this);
  },
  _onPause$0: function() {
    this.get$_liblib2$_controller()._recordPause$1(this);
  },
  get$_onPause: function() {
    return new $.BoundClosure$0(this, "_onPause$0", null);
  },
  _onResume$0: function() {
    this.get$_liblib2$_controller()._recordResume$1(this);
  },
...
_BroadcastStream: {"": "_StreamImpl;_liblib2$_controller",
  get$isBroadcast: function() {
    return true;
  },
  _createSubscription$4: function(onData, onError, onDone, cancelOnError) {
...
_BroadcastSubscription: {"": "_ControllerSubscription;_eventState@,_liblib2$_next@,_liblib2$_previous@,_liblib2$_controller,_onData,_onError,_onDone,_state,_pending",
...
_BroadcastStreamController: {"": "Object;_onListen<,_state@,_liblib2$_next@,_liblib2$_previous@",
...
_AsBroadcastStream: {"": "Stream;_source,_liblib2$_controller,_subscription",
  get$isBroadcast: function() {
    return true;
  },
  listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
  ...
  _onCancel$0: function() {
    ...
    this._subscription = null;
    this._liblib2$_controller = null;
...
["dart.math", "dart:math", , {
_Random: {"": "Object;"}}],
["dartpoker.dart", "dartpoker.dart", , {
init_closure: {"": "Closure;p1_0",
  call$1: function(_) {
    return $.createView(this.p1_0);
  }
},
...
init: function() {
  var t1, d, p;
  $.cardTable = document.querySelector("#card_table");
  ...
  d.players.push(p);
  d.deck.shuffle$1(1);
  d._onDealCompleteEvent.stream.listen$1(new $.init_closure(p));
  d.dealToAllPlayers$1(5);
  p.printHand$0();
},

createView: function(p) {
  var t1, cvi, t2;
  for (t1 = p.hand.cards, t1.get$iterator, t1 = new $.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
    cvi = $.CardViewItem$(t1._liblib$_current);
    t2 = $.get$children$x($.cardTable);
    t2.add$1(t2, cvi.cardElement);
  }
}}],
...
DomName: {"": "Object;name"}}],
["playingCards", "model/cardsModel.dart", , {
CardVO: {"": "Object;suit<,rank<",
  toString$0: function(_) {
    return $.S(this.suit) + ", " + $.S(this.rank);
  }
},

Stack: {"": "Object;cards",
  makeDeck$1: function(totalDecks) {
    var i, k, j, t1, t2, t3;
    $.get$Stack_ranks();
    $.get$Stack_suits();
    this.cards = [];
    for (i = 0, k = null; i < totalDecks; ++i)
      for (j = 0; j < $.get$Stack_suits().length; ++j)
        for (k = 0; k < $.get$Stack_ranks().length; ++k) {
          t1 = this.cards;
          t2 = $.get$Stack_suits();
          if (j >= t2.length)
            throw $.ioore(j);
          ...
          if (k >= t3.length)
            throw $.ioore(k);
          t1.push(new $.CardVO(t2, t3[k]));
        }
  },
  shuffle$1: function(n) {
    var temp, i, j, max, t1, truncated, k, t2;
    for (temp = null, i = 0; i < n; ++i)
      for (j = 0; max = this.cards.length, j < max; ++j) {
        if (max > 4294967295)
          max = 4294967295;
        t1 = Math.floor(Math.random() * max >>> 0);
        if (isNaN(t1))
          $.throwExpression(new $.UnsupportedError("NaN"));
        if (t1 == Infinity || t1 == -Infinity)
          $.throwExpression(new $.UnsupportedError("Infinity"));
        truncated = t1 < 0 ? Math.ceil(t1) : Math.floor(t1);
        k = truncated == -0.0 ? 0 : truncated;
        t1 = this.cards;
        t2 = t1.length;
        if (j >= t2)
          throw $.ioore(j);
...
Isolate.$lazy($, "ranks", "Stack_ranks", "get$Stack_ranks", function() {
  return ["2", "3", "4", "5", "6", "7", "8", "9", "10", "j", "q", "k", "a"];
});
Isolate.$lazy($, "suits", "Stack_suits", "get$Stack_suits", function() {
  return ["clubs", "diams", "hearts", "spades"];
});
// Native classes
...
//@ sourceMappingURL=dartpoker.dart.js.map
